...
BOOL LScamera,LSflash,LSicon,nodndbanner,kEnableOnLockscreen,autoDismiss;
...
static void loadPrefs() {
	...
	autoDismiss = [prefs objectForKey:@"autoDismiss"] ? [[prefs objectForKey:@"autoDismiss"] boolValue] : YES;
